...
export class UniverseWorld {
  ...
  _buildAtmosphere(){const atm=createAtmosphereScene(-9060);this._track(atm.group,'atmosphere',['orbit','atmosphere']);this.updatables.push(atm.group);atm.interactives.forEach(({object,id})=>this._register(object,'atmosphere',id))}
  _buildSurface(){const s=createSurfaceScene(-9730);this._track(s.group,'surface',['atmosphere','surface']);this.updatables.push(s.group);s.interactives.forEach(({object,id})=>this._register(object,'surface',id))}
