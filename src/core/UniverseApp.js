...
export class UniverseApp {
  ...
  animate=()=>{requestAnimationFrame(this.animate);const time=this.clock.getElapsedTime();this.journey.update();this.world.update(time,this.journey.stageIndex);this.hud.update(this.journey.stageIndex,this.journey.localProgress,this.journey.globalProgress);this.interaction.update(STAGES[this.journey.stageIndex].id);this.composer.render()}
}
